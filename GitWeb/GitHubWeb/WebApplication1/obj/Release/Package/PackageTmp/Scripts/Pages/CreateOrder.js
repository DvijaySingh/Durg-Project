$(document).ready(function () {
    ...
    $('#btncustInfo').click(function () {
        if ($('button span').hasClass('glyphicon-chevron-down')) {
            $('#btncustInfo').html('<span class="glyphicon glyphicon-chevron-right"></span>Customer Info');
        }
        else {
            $('#btncustInfo').html('<span class="glyphicon glyphicon-chevron-down"></span>Customer Info');
        }
    });
